"""
Django settings for AgeComparisonPollingBot project.
...
# IMPORTANTE: PER FAR FUNZIONARE IL BOT, E' NECESSARIO USARE use_context=True come specificato in
# https://github.com/python-telegram-bot/python-telegram-bot/wiki/Transition-guide-to-Version-12.0
# nella libreria django!
...
ROOT_URLCONF = 'AgeComparisonPollingBot.urls'
...
WSGI_APPLICATION = 'AgeComparisonPollingBot.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'db.sqlite3'),  # TODO cambiare DB in production
    }
}
...
DJANGO_TELEGRAMBOT = {
    ...
    'BOTS' : [
        {
           'TOKEN': os.environ['AI_CHALLENGE_BOT_TOKEN'],
